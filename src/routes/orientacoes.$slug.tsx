...
import { EditorialContact, EditorialNotice, EditorialReview } from "@/components/site/Editorial";
  ...
  return (
    <>
      ...
      <div className="px-5 pb-4">
        <header className="mx-auto max-w-4xl py-10 sm:py-14">
          <Link
            to="/orientacoes"
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight tracking-tight sm:text-5xl sm:leading-tight">
            {article.title}
          </h1>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-14">
          <nav
            ...
            className="self-start rounded-2xl border border-border p-5 lg:sticky lg:top-28"
          >
          ...
          <article className="editorial-prose min-w-0 max-w-3xl text-lg leading-relaxed">
            <div className="rounded-r-2xl border-l-4 border-deep bg-secondary p-6 sm:p-8">
              <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-deep">
                Resposta direta
              </p>
              <p>{article.answer}</p>
            </div>
            ...
            <section id="perguntas" className="mt-12 scroll-mt-28">
              ...
              {article.faqs.map((faq) => (
                <details key={faq.question} className="border-b border-border py-5">
                  <summary className="cursor-pointer rounded-sm pr-3 font-semibold focus-visible:outline-2 focus-visible:outline-offset-4">
                    {faq.question}
                  </summary>
